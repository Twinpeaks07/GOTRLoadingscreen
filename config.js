...
config.logo_image = "GOTR Logo2.png"

// Text to be shown on logo
config.logo_text = "Galaxy of the Republic"
...
config.background_images = [
	...
	"wallpaperflare.com_wallpaper1.jpg",
	"wallpaperflare.com_wallpaper2.jpg",
	"wp4840305-trooper-wallpapers.jpg",
	"wp4896684-arc-troopers-wallpapers.jpg",
	"wp8834409-clone-trooper-phase-1-wallpapers.jpg",
]
...
config.music_playlist = [
	{
		name: "Star Wars - We Are Soldiers",
		file: "Star Wars - We Are Soldiers.ogg",
	},
	{
		name: "Star Wars AMV [Warriors]",
		file: "Star Wars AMV [Warriors].ogg",
	},
	{
		name: "Star Wars The Clone Wars AMV [Finish Line]",
		file: "Star Wars The Clone Wars AMV [Finish Line].ogg",
	},
	{
		name: "Hey Brother - Clone Wars",
		file: "Hey Brother - Clone Wars.ogg",
	},
]
...
config.messages_list = [
	"Willkommen bei Galaxy of the War",
	"Beim ersten mal Joinen auf unseren Server kann es etwas länger dauern als Normalerweise",
	"Bitte lies dir die Regeln durch und halte dich auch dran",
	"Viel Spaß beim Spielen!",
	"Zitat von Rex: Meiner Meinung nach, geht Erfahrung über alles.",
